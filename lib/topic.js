...
exports.page = function(request, response, queryData){
    ...
    //또한 공격성이 있는것은 알아서 필터링 하는 역할도 함. 따라서 아래 방법이 좀 더 보안성 높음,  string화 시켜줌으로서 ;delete 명령 추가로 기입해도 작동 안하도록 해줌. 이걸 injection공격이라 하는듯
    //localhost:3000/?id=1;DROP%20TABLE%20topic;
